...
list_consumables_rare=['adler-cheese','camembert-cheese','champignon-cheese','karwendel-cheese','wine','beer','vodka']
...
def spawn_object(world,world_coords,object_type, spawn):
    ...
    # this is the base object for the sd.kfz.234 variants. It is not meant to be spawned by itself
        ...
        # AP
        for b in range(40):
            z.ai.ammo_rack.append(spawn_object(world,world_coords,"5cm_kwk39_l60_magazine",False))
        # HE
        for b in range(15):
        ...
        z.is_gun=True
        z.ai.mechanical_accuracy=10
        z.ai.magazine=spawn_object(world,world_coords,'5cm_kwk39_l60_magazine',False)
        z.ai.rate_of_fire=0.13
        z.ai.range=4000
        z.ai.type='cannon'
        z.ai.use_antitank=True
