...
def spawn_object(world, world_coords, object_type, spawn):
    ...
    if object_type == "warehouse":
        ...
        z = spawn_object(world, world_coords, "crate", False)
        z.add_inventory(
            spawn_object(world, world_coords, random.choice(list_consumables), False)
        )
        z.add_inventory(
            spawn_object(world, world_coords, random.choice(list_consumables), False)
        )
        ...
        if random.randint(0, 1) == 1:
            z.ai.inventory.append(
                get_random_from_list(world, world_coords, list_household_items, False)
            )
            z.ai.inventory.append(
                get_random_from_list(world, world_coords, list_household_items, False)
            )
        if random.randint(0, 1) == 1:
            z.ai.inventory.append(
                get_random_from_list(world, world_coords, list_consumables, False)
            )
        ...
        z.ai.magazine = spawn_object(
            world, world_coords, "panzerfaust_60_magazine", False
        )
    ...
    # for the su-85. same ammo as the t34-85 gun, same pen
        ...
        z.ai.fuel_tanks.append(
            spawn_object(world, world_coords, "vehicle_fuel_tank", False)
        )
        ...
        z.ai.batteries.append(
            spawn_object(world, world_coords, "battery_vehicle_6v", False)
        )
        ...
        z.ai.front_left_wheels.append(
            spawn_object(world, world_coords, "g505_wheel", False)
        )
        ...
        z.ai.engines.append(
            spawn_object(world, world_coords, "deutz_diesel_65hp_engine", False)
        )
        z.ai.engines[0].ai.exhaust_position_offset = [75, 10]
        z.ai.batteries.append(
            spawn_object(world, world_coords, "battery_vehicle_6v", False)
        ...
        for b in range(2):
            z.ai.front_left_wheels.append(
                spawn_object(world, world_coords, "rso_wheel", False)
            )
            z.ai.front_right_wheels.append(
                spawn_object(world, world_coords, "rso_wheel", False)
            )
        ...
        for b in range(20):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "75mm_pak40_magazine", False)
            )
        for b in range(4):
    ...
    # this is the base object for the sd.kfz.10 variants. It is not meant to be spawned by itself
        ...
        fill_container(world, z.ai.fuel_tanks[0], "gas_80_octane")
        z.ai.engines.append(
            spawn_object(world, world_coords, "maybach_hl42_engine", False)
        )
        z.ai.engines[0].ai.exhaust_position_offset = [75, 10]
        z.ai.batteries.append(
            spawn_object(world, world_coords, "battery_vehicle_6v", False)
        ...
        z.ai.max_spare_wheels = 0
        z.ai.front_left_wheels.append(
            spawn_object(world, world_coords, "251_wheel", False)
        )
        z.ai.front_right_wheels.append(
            spawn_object(world, world_coords, "251_wheel", False)
        )
    ...
    # this is the default transport model with camo
    ...
    elif object_type == "german_sd_kfz_222":
        z = WorldObject(world, ["sd_kfz_222_chassis"], AIVehicle)
        z.name = "Sd.Kfz.222"
        z.is_vehicle = True
        z.is_towable = True
        ...
        z.ai.vehicle_armor["right"] = [8, 35, 0]
        z.ai.vehicle_armor["front"] = [30, 35, 0]
        z.ai.vehicle_armor["rear"] = [8, 34, 0]
        ...
        z.ai.passenger_compartment_armor["front"] = [14.5, 33, 0]
        z.ai.passenger_compartment_armor["rear"] = [8, 34, 0]
        z.ai.max_speed = 385.9
        z.ai.max_offroad_speed = 177.6
        z.ai.rotation_speed = 40.0
        z.collision_radius = 100
        ...
        for b in range(10):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "2cm_kwk38_l55_magazine", False)
            )
        # HE
        for b in range(5):
    ...
    elif object_type == "german_sd_kfz_222_camo":
        z = spawn_object(world, world_coords, "german_sd_kfz_222", False)
    ...
    # this is the base object for the sd.kfz.234 variants. It is not meant to be spawned by itself
    ...
    elif object_type == "german_sd_kfz_234/2":
        # ref : https://wiki.warthunder.com/unit/germ_sdkfz_251_9
        # https://en.wikipedia.org/wiki/Sd.Kfz._251
        z = spawn_object(world, world_coords, "german_sd_kfz_234_base", False)
        z.name = "Sd.Kfz.234/2 Puma"
        z.ai.passenger_compartment_ammo_racks = True
        z.ai.requires_afv_training = True
        z.ai.is_transport = False
        turret = spawn_object(world, world_coords, "234_2_turret", True)
        z.ai.turrets.append(turret)
        turret.ai.vehicle = z
        ...
        for b in range(40):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "5cm_kwk39_l60_magazine", False)
            )
        # HE
        for b in range(15):
            temp = spawn_object(world, world_coords, "5cm_kwk39_l60_magazine", False)
        ...
        z.ai.position_offset = [-16, 0]
        z.ai.rotation_range = [-360, 360]
        z.ai.primary_weapon = spawn_object(world, world_coords, "5cm_kwk39_l60", False)
        z.ai.primary_weapon.ai.smoke_on_fire = True
        z.ai.primary_weapon.ai.smoke_type = "cannon"
        z.ai.primary_weapon.ai.smoke_offset = [-70, 0]
        z.ai.primary_weapon.ai.spawn_case = False
    ...
    elif object_type == "5cm_kwk39_l60":
        # ref : https://en.wikipedia.org/wiki/2_cm_KwK_30
        z = WorldObject(world, ["mg34"], AIGun)
        z.no_update = True
        z.name = "5cm KwK 39 L60"
        z.is_gun = True
        z.ai.mechanical_accuracy = 10
        z.ai.mechanical_accuracy_deg = 0.15
        z.ai.magazine = spawn_object(
    ...
    elif object_type == "5cm_kwk39_l60_magazine":
        z = WorldObject(world, ["stg44_magazine"], AIMagazine)
        z.name = "2cm KWK 38 L55 magazine"
        z.minimum_visible_scale = 0.4
        z.is_gun_magazine = True
    ...
    # note this is the weapon, not the entire system
        ...
        for b in range(40):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "75mm_kwk37_l24_magazine", False)
            )
        # HEAT
        for b in range(12):
        ...
        fill_container(world, z.ai.fuel_tanks[0], "diesel")
        z.ai.engines.append(
            spawn_object(world, world_coords, "kharkiv_v2-34_engine", False)
        )
        z.ai.engines[0].ai.exhaust_position_offset = [75, 10]
        z.ai.batteries.append(
            spawn_object(world, world_coords, "battery_vehicle_6v", False)
        ...
        for b in range(60):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "75mm_kwk40_l43_magazine", False)
            )
        for b in range(27):
        ...
        for b in range(4):
            z.ai.front_left_wheels.append(
                spawn_object(world, world_coords, "panzeriv_wheel", False)
            )
            z.ai.front_right_wheels.append(
                spawn_object(world, world_coords, "panzeriv_wheel", False)
            )
    ...
    # this is the late war german smoke/he mortar device
        ...
        z.ai.position_offset = [0, 0]
        z.ai.rotation_range = [-360, 360]
        z.ai.primary_weapon = spawn_object(
        ...
        # ref : https://wiki.warthunder.com/unit/germ_pzkpfw_IV_ausf_G
        z = WorldObject(
            world, ["panzer_iv_h_chassis", "panzer_iv_h_chassis_destroyed"], AIVehicle
        )
        ...
        for b in range(60):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "75mm_kwk40_l48_magazine", False)
            )
        for b in range(27):
    ...
    # J is a H with simplicication. schurtzen are replaced with wire schurtzen on the hull (thin)
        ...
        mg_turret.ai.vehicle = z
        z.ai.radio = spawn_object(world, world_coords, "radio_feldfu_b", False)
        n_turret = spawn_object(
            world, world_coords, "nahverteidigungswaffe_turret", True
        )
        ...
        for b in range(10):
            z.add_inventory(
                spawn_object(world, world_coords, "kampfpistole_magazine", False)
            )
        z.ai.ammo_rack_capacity = 87
        for b in range(60):
            z.ai.ammo_rack.append(
        ...
        z.ai.mechanical_accuracy_deg = 0.12
        z.ai.magazine = spawn_object(
            world, world_coords, "75mm_kwk40_l48_magazine", False
        )
        z.ai.rate_of_fire = 1
        z.ai.reload_speed = 20
        z.ai.range = 4000
        ...
        for b in range(50):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "8.8cm_pak43_l71_magazine", False)
            )
        for b in range(25):
    ...
    elif object_type == "8.8cm_pak43_l71_magazine":
        z = WorldObject(world, ["stg44_magazine"], AIMagazine)
        z.name = "8.8cm_pak43_l71_magazine"
        z.minimum_visible_scale = 0.4
        z.is_gun_magazine = True
        z.ai.compatible_guns = ["8.8cm_pak43_l71"]
        z.ai.compatible_projectiles = ["PzGr39_88_L71", "Sprgr_34_88_L71"]
        z.ai.capacity = 1
        z.ai.disintegrating = True
        z.rotation_angle = float(random.randint(0, 359))
        load_magazine(world, z)
        ...
        for b in range(60):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "8.8cm_kwk36_l56_magazine", False)
            )
        for b in range(32):
    ...
    # +camo
        ...
        for b in range(2):
            z.ai.front_left_wheels.append(
                spawn_object(world, world_coords, "t20_wheel", False)
            )
            z.ai.front_right_wheels.append(
                spawn_object(world, world_coords, "t20_wheel", False)
            )
    ...
    # this is the base object for the sd.kfz.10 variants. It is not meant to be spawned by itself
        ...
        main_turret = spawn_object(
            world, world_coords, "t34_76_model_1943_turret", True
        )
        z.ai.turrets.append(main_turret)
        main_turret.ai.vehicle = z
        ...
        for b in range(60):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "76mm_m1940_f34_magazine", False)
            )
        for b in range(17):
        ...
        for b in range(3):
            z.ai.front_left_wheels.append(
                spawn_object(world, world_coords, "t34_wheel", False)
            )
            z.ai.front_right_wheels.append(
                spawn_object(world, world_coords, "t34_wheel", False)
            )
        ...
        for b in range(50):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "85mm_zis_s_53_magazine", False)
            )
        for b in range(7):
        ...
        for b in range(45):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "45mm_19k_magazine", False)
            )
        z.ai.min_wheels_per_side_front = 2
        z.ai.min_wheels_per_side_rear = 2
        z.ai.max_wheels = 12
        ...
        for b in range(25):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "100mm_d_10_magazine", False)
            )
        for b in range(5):
        ...
        for b in range(30):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "7.5cm_pak39_L48_magazine", False)
            )
        for b in range(11):
        ...
        for b in range(2):
            z.ai.front_left_wheels.append(
                spawn_object(world, world_coords, "panzer38t_wheel", False)
            )
            z.ai.front_right_wheels.append(
                spawn_object(world, world_coords, "panzer38t_wheel", False)
            )
        ...
        # !! note - turrets should be spawned with spawn TRUE as they are always in world
        z = WorldObject(
            world, ["jagdpanzer_38t_main_gun", "jagdpanzer_38t_main_gun"], AITurret
        )
        ...
        z.ai.rotation_range = [-20, 20]
        z.ai.primary_weapon = spawn_object(
            world, world_coords, "7.5cm_pak39_L48", False
        )
        z.ai.primary_weapon.ai.equipper = z
        z.ai.primary_weapon.ai.smoke_on_fire = True
        z.ai.primary_weapon.ai.smoke_type = "cannon"
        ...
        for b in range(10):
            z.ai.ammo_rack.append(
                spawn_object(world, world_coords, "37mm_m1939_k61_magazine", False)
            )
        for b in range(5):
        ...
        z.ai.max_spare_wheels = 0
        z.ai.front_left_wheels.append(
            spawn_object(world, world_coords, "gun_carriage_wheel", False)
        )
        z.ai.front_right_wheels.append(
            spawn_object(world, world_coords, "gun_carriage_wheel", False)
        )
    ...
    # this is vehicle+gun for a field type mortar
        ...
        # ref : https://tanks-encyclopedia.com/ww2/nazi_germany/sdkfz-251_hanomag.php
        z = WorldObject(
            world, ["pak40_carriage_deployed", "pak40_carriage_deployed"], AIVehicle
        )
        z.name = "PAK 40"
        z.is_vehicle = True
        z.is_towable = True
        ...
        z.ai.max_spare_wheels = 0
        z.ai.front_left_wheels.append(
            spawn_object(world, world_coords, "pak_wheel", False)
        )
        z.ai.front_right_wheels.append(
            spawn_object(world, world_coords, "pak_wheel", False)
        )
        ...
        fill_container(world, z.ai.fuel_tanks[0], "gas_80_octane")
        z.ai.engines.append(
            spawn_object(world, world_coords, "volkswagen_type_82_engine", False)
        )
        ...
        z.ai.max_spare_wheels = 1
        z.ai.front_left_wheels.append(
            spawn_object(world, world_coords, "volkswagen_wheel", False)
        )
        z.ai.front_right_wheels.append(
            spawn_object(world, world_coords, "volkswagen_wheel", False)
        )
        ...
        z.add_inventory(
            get_random_from_list(
                world, world_coords, list_german_military_equipment, False
            )
        )
        z.rotation_angle = float(random.randint(0, 359))
        ...
        z = WorldObject(
            world, ["ju88-winter-weathered", "ju88-winter-weathered"], AIVehicle
        )
        z.name = "Junkers Ju88"
        ...
        z.ai.batteries.append(
            spawn_object(world, world_coords, "battery_vehicle_24v", False)
        )
    ...
    # dani cat. wow!
        ...
        z = WorldObject(
            world, ["german_soldier", "german_soldier_prone", "german_dead"], AIHuman
        )
    ...
    # --------- soviet types ----------------------------------------
        ...
        z.add_inventory(
            spawn_object(world, world_coords, "german_folding_shovel", False)
        )
