    ...
    def debug_menu(self, key):
        ...
        if self.menu_state=='spawn_vehicles':
            ...
            if key=='1':
                ...
                engine.world_builder.spawn_object(self.world, [self.world.player.world_coords[0]+50,self.world.player.world_coords[1]],'soviet_t70',True)
            elif key=='3':
