    ...
    def debug_menu(self, key):
        ...
        if self.menu_state=='spawn_vehicles':
            ...
            if key=='1':
                ...
                engine.world_builder.spawn_object(self.world, [self.world.player.world_coords[0]+50,self.world.player.world_coords[1]],'german_sd_kfz_251/23',True)
            elif key=='4':
                ...
                engine.world_builder.spawn_object(self.world, [self.world.player.world_coords[0]+50,self.world.player.world_coords[1]],'german_sd_kfz_234/1',True)
            elif key=='6':
                ...
                engine.world_builder.spawn_object(self.world, [self.world.player.world_coords[0]+50,self.world.player.world_coords[1]],'soviet_t34_85',True)
        if self.menu_state=='spawn_weapons':
            ...
            if key=='1':
                engine.world_builder.spawn_object(self.world, [self.world.player.world_coords[0]+50,self.world.player.world_coords[1]],'kampfpistole',True)
                engine.world_builder.spawn_object(self.world, [self.world.player.world_coords[0]+50,self.world.player.world_coords[1]],'kampfpistole_magazine',True)
                engine.world_builder.spawn_object(self.world, [self.world.player.world_coords[0]+50,self.world.player.world_coords[1]],'kampfpistole_magazine',True)
            elif key=='2':
        ...
        if self.menu_state=='spawn_misc':
            ...
            if key=='1':
                ...
                engine.world_builder.spawn_object(self.world, [self.world.player.world_coords[0]+40,self.world.player.world_coords[1]],'pinus_sylvestris',True)
            elif key=='4':
                ...
                engine.world_builder.spawn_object(self.world, [self.world.player.world_coords[0]+40,self.world.player.world_coords[1]],'vodka',True)
            elif key=='6':
