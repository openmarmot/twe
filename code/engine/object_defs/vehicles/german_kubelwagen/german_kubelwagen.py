"""
german_kubelwagen object definition
...
def create(world, world_coords):
    ...
    if random.randint(0, 1) == 1:
        z.add_inventory(engine.world_builder.spawn_object(world, world_coords, "beer", False))
        z.add_inventory(engine.world_builder.spawn_object(world, world_coords, "beer", False))
        z.add_inventory(engine.world_builder.spawn_object(world, world_coords, "wine", False))
