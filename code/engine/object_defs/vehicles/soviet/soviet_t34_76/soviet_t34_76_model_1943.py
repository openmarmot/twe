"""
soviet_t34_76_model_1943 object definition
...
@register_object("soviet_t34_76_model_1943")
def create(world, world_coords):
    ...
    main_turret = engine.world_builder.spawn_object(
        world, world_coords, "t34_76_model_1943_turret", True
    )
    z.ai.turrets.append(main_turret)
    main_turret.ai.vehicle = z
    mg_turret = engine.world_builder.spawn_object(world, world_coords, "t34_hull_mg_turret", True)
