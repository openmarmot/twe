"""
german_panzer_iv_ausf_h object definition
...
@register_object("german_panzer_iv_ausf_h")
def create(world, world_coords):
    ...
    main_turret = engine.world_builder.spawn_object(world, world_coords, "panzer_iv_h_turret", True)
