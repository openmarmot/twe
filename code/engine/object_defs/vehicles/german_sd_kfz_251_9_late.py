"""
german_sd_kfz_251/9_late object definition
...
@register_object("german_sd_kfz_251/9_late")
def create(world, world_coords):
    ...
    turret = engine.world_builder.spawn_object(world, world_coords, "251_9_late_turret", True)
