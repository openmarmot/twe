"""
german_8cm_mortar_turret object definition
...
@register_object("german_8cm_mortar_turret")
def create(world, world_coords):
    # !! note - turrets should be spawned with spawn TRUE as they are always in world
    # field mortar tube. the Sd.Kfz.251/2 keeps 251_2_turret (hull offset).
    # tube sprite is still 251_2_turret until this mount has its own art.
    z = WorldObject(world, ["251_2_turret"], AITurret)
    z.name = "8cm Granatwerfer 34 Turret"
