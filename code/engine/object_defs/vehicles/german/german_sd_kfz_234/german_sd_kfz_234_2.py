"""
german_sd_kfz_234/2 object definition
...
@register_object("german_sd_kfz_234/2")
def create(world, world_coords):
    ...
    turret = engine.world_builder.spawn_object(world, world_coords, "234_2_turret", True)
    ...
    for b in range(15):
        ...
        engine.world_builder.load_magazine(world, temp, "Sprgr_38_50_L60")
