"""
german_panzer_vi_ausf_e object definition
...
@register_object("german_panzer_vi_ausf_e")
def create(world, world_coords):
    ...
    main_turret = engine.world_builder.spawn_object(world, world_coords, "panzer_vi_ausf_e_turret", True)
    ...
    n_turret = engine.world_builder.spawn_object(
    ...
    z.add_inventory(engine.world_builder.spawn_object(world, world_coords, "kampfpistole", False))
    z.rotation_angle = float(random.randint(0, 359))
    for b in range(10):
        z.add_inventory(engine.world_builder.spawn_object(world, world_coords, "mg34_belt", False))
    for b in range(10):
        z.add_inventory(
            engine.world_builder.spawn_object(world, world_coords, "kampfpistole_magazine", False)
        )
    # armor piercing belt
