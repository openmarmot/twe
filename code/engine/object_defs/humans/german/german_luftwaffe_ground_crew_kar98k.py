"""
german_luftwaffe_ground_crew_kar98k object definition
...
@register_object("german_luftwaffe_ground_crew_kar98k")
def create(world, world_coords):
    ...
    engine.world_builder.add_standard_loadout(z, world, "kar98k")
    return z
