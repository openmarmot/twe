...
class AIHuman(object):
    ...
    def calculate_engagement(self,weapon,target):
        ...
        if target.is_vehicle:
            penetration,pen_value,armor_value=engine.penetration_calculator.calculate_penetration(weapon.ai.magazine.ai.projectiles[0],distance,'steel',target.ai.passenger_compartment_armor['left'])
            return penetration
    ...
    def calculate_projectile_damage(self,projectile,distance):
        ...
        if hit==1:
            ...
            if self.wearable_head is None:
                ...
                penetration,pen_value,armor_value=engine.penetration_calculator.calculate_penetration(projectile,distance,'steel',self.wearable_head.ai.armor)
                if penetration:
            ...
            if self.wearable_upper_body is None:
                ...
                penetration,pen_value,armor_value=engine.penetration_calculator.calculate_penetration(projectile,distance,'steel',self.wearable_upper_body.ai.armor)
                if penetration:
                    self.blood_pressure-=random.randint(30,75)
                    bleeding_hit=True
                else:
    ...
    def update_task_engage_enemy_vehicle(self):
        ...
        if self.antitank is not None:
            ...
            if ammo_gun>0:
                penetration,pen_value,armor_value=engine.penetration_calculator.calculate_penetration(self.primary_weapon.ai.magazine.ai.projectiles[0],distance,'steel',enemy.ai.vehicle_armor['left'])
                if penetration is False:
                    penetration,pen_value,armor_value=engine.penetration_calculator.calculate_penetration(self.primary_weapon.ai.magazine.ai.projectiles[0],distance,'steel',enemy.ai.passenger_compartment_armor['left'])
